...
$tabledit->table = 'lehrveranstaltungen';
...
$tabledit->fields_in_list_view = array('ID','abk', 'name');
...
$tabledit->fields_required = array( 'ID','abk', 'name');

# Fields you want to edit (remove this to edit all the fields).
 $tabledit->fields_to_edit = array('ID','abk', 'name');
